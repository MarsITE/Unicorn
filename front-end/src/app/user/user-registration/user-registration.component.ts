...
export class UserRegistrationComponent implements OnInit, OnDestroy {
  ...
  public submit(): void {
    // this.user = { email: this.userForm.controls.email.value, password: this.userForm.controls.passwors.value, roles: [] };

    this.saveUser({ email: this.userForm.controls.email.value, password: this.userForm.controls.password.value, roles: [] });
  }
}
